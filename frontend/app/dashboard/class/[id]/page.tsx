...
const posts = [
  {
    ...
    date: 'May 24, 2020',
    content:
      'Use this link to log in with your google classroom email. This is the typing website to work on over the summer.',
    ...
    comments: [
      {
        ...
        date: 'Feb 25',
        content:
          'Waddup fellas if anyone sees this then add me on my discord pieaareepic_23473',
        avatar: 'K',
      },
    ],
  },
            ...
            {post.comments.length > 0 && (
              <div className="border-t border-gray-200 dark:border-gray-700 px-4 py-3">
                <button className="flex items-center gap-2 text-blue-600 dark:text-blue-400 hover:underline text-sm font-medium">
                  <Users size={16} />
                  {post.comments.length} class comment
                ...
                <button
                  onClick={() => {
                    if (commentInputs[post.id]?.trim()) {
                      console.log('Posting comment:', commentInputs[post.id]);
