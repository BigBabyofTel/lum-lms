...
export default function Navbar({
  ...
  return (
    <nav className="fixed top-0 right-0 left-0 h-16 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 z-50">
          ...
          <h1 className="text-xl font-bold text-gray-800 dark:text-white">
            {title || (
              <>
                ...
                <span className="text-indigo-700 dark:text-orange-600">m</span>
                ine
                <span className="text-indigo-700 dark:text-orange-600">s</span>
                cence
              </>
            )}
          </h1>
